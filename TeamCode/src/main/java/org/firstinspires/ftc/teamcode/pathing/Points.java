...
public class Points {
    ...
    public final static Pos2D RNeutral = new Pos2D(52.5,315.5,-0.24);
    public final static Pos2D MNeutral = new Pos2D(48,314,0.18);
    public final static Pos2D LNeutral = new Pos2D(54,315,0.6);

    public final static Pos2D BasketDeliver = new Pos2D(40,316,-Math.PI/4);
    ...
    public final static Pos2D observeGrab = new Pos2D(30, 75, 2*Math.PI);
    ...
    public final static Pos2D RSpecimenDeliver = new Pos2D(97.5,180, 2*(Math.PI));
    ...
    public final static Pos2D LColor1 = new Pos2D(50,90,(3*(Math.PI)/2));
    public final static Pos2D LColor2 = new Pos2D(LColor1.x + 207, LColor1.y + 31, LColor1.theta);
    public final static Pos2D LColor3 = new Pos2D(LColor1.x + 185, LColor1.y - 20, LColor1.theta);
    public final static Pos2D LColor4 = new Pos2D(LColor1.x + 202, LColor1.y - 31 - 26, LColor1.theta);
    public final static Pos2D LColor5 = new Pos2D(LColor1.x , LColor1.y - 40, LColor1.theta);
    ...
    public final static Pos2D MColor3 = new Pos2D(MColor1.x + 210, MColor1.y - 35, MColor1.theta);
    public final static Pos2D MColor4 = new Pos2D(MColor1.x + 202, MColor1.y - 31 - 26, MColor1.theta);
    public final static Pos2D MColor5 = new Pos2D(MColor1.x , MColor1.y - 45, MColor1.theta);
    ...
    public final static Pos2D RColor3 = new Pos2D(RColor1.x + 185, RColor1.y - 25, RColor1.theta);
    public final static Pos2D RColor4 = new Pos2D(RColor1.x + 202, RColor1.y - 31 - 26, RColor1.theta);
    public final static Pos2D RColor5 = new Pos2D(RColor1.x , RColor1.y - 25, RColor1.theta);
