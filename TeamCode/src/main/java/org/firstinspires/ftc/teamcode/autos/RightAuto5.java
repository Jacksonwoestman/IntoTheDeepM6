...
public class RightAuto5 extends LinearOpMode {
    ...
    ArrayList<Pos2D> PreSpecimenPickupfromR = new ArrayList<>(Arrays.asList(Points.MColor5, Points.observeGrab));
    ...
    private void observeReadyCycle() throws InterruptedException {
        ...
        Thread.sleep(100);
        specimenGrab++;
        Pos2D targetPos = new Pos2D(Points.observeGrab.x-1.5 * specimenGrab, Points.observeGrab.y, Points.observeGrab.theta);
